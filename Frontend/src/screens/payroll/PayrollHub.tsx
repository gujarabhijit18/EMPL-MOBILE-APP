// 📂 src/screens/payroll/PayrollHub.tsx
...
export default function PayrollHub() {
    ...
    const canAccessFull = role === "admin" || role === "hr";
    const canViewOwn = true; // All employees can view their payslips

    const modules = canAccessFull ? [
        {
            title: "Dashboard",
        ...
        },
        {
            ...
            screen: "PayrollApproval",
            badge: 3,
        },
        {
            title: "Payslips",
            subtitle: "Generate & view",
            icon: <FileText size={32} color="#fff" />,
            gradient: ["#4facfe", "#00f2fe"] as const,
            screen: "PayslipManagement",
        },
        {
            title: "Disbursement",
                        ...
                        <View style={styles.headerContent}>
                            ...
                            <View style={styles.headerTextContainer}>
                                ...
                                <Text style={styles.headerSubtitle}>
                                    {canAccessFull ? "Complete payroll management" : "Your salary information"}
                                </Text>
                            </View>
                        </View>
                    </LinearGradient>
