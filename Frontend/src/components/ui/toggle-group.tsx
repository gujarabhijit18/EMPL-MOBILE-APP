 ...
 * ✅ Works on iOS, Android, and Web with Expo Go
 * Features:
 * - Single or multiple selection
 * - Two style variants: Default & Outline
 * - Three size options: sm, default, lg
 * - Fully Expo-safe (no native linking or Android-specific styles)
 */
...
const styles = StyleSheet.create({
  ...
  item: {
    ...
    justifyContent: "center",
    marginHorizontal: 4,
    marginVertical: 2, // gap replacement for Expo
  },
  expoShadow: {
    // ✅ Expo-safe shadow styling
    shadowColor: "#000",
    shadowOpacity: 0.1,
    shadowRadius: 4,
